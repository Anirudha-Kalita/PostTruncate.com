...
<p>Threads belønner <strong>samtaleorienteret, direkte skrivning</strong> frem for poleret broadcast-tekst. At afslutte det første opslag med et ægte spørgsmål eller en udtalt holdning som læsere kan sætte spørgsmålstegn ved, er konsekvent mere effektivt end at afslutte med en opfordring til handling.</p>`,
...

  {
    ...
    slugs: {
      ...
      es: 'verificador-leyendas-tiktok',
      de: 'tiktok-untertitel-pruefer',
      fr: 'verificateur-legendes-tiktok',
      pt: 'verificador-legendas-tiktok',
      it: 'controllo-didascalie-tiktok',
      nl: 'tiktok-bijschrift-checker',
      ja: 'tiktok-caption-checker',
      zh: 'tiktok-wenan-jiancha',
      da: 'tiktok-billedtekst-tjek',
    },
    ...
    schemaName: {
      ...
      pt: 'Verificador de Legendas do TikTok',
      it: 'Controllo Didascalie per TikTok',
      nl: 'TikTok Bijschrift-checker',
      ja: 'TikTok キャプションチェッカー',
      zh: 'TikTok 文案检查器',
      da: 'TikTok Billedtekst-tjek',
    },
    ...
    faq: {
      en: [
        ...
        },
        {
          ...
          a: 'TikTok videos are designed for a full-screen vertical experience with a 9:16 aspect ratio, requiring a resolution of 1080 × 1920 pixels. Filming or rendering outside of these exact dimensions will result in black bars on the screen or automatic cropping that can ruin your video\'s framing.',
        },
        {
          q: 'What are the TikTok Safe Zones for video text and graphics?',
          a: 'The TikTok Safe Zone is the central area of your 9:16 video where hardcoded text and stickers will not be blocked by native app elements. To prevent your content from being hidden, you must avoid placing critical visuals in three "dead zones": The Bottom (~20%): Covered by your username, caption, and the scrolling music ticker. The Right Side (~15%): Covered by the engagement stack (profile picture, like, comment, bookmark, and share icons). The Top (~10%): Covered by the status bar and "For You" navigation tabs.',
        },
        {
          q: 'Are TikTok In-Feed Ad text limits different from organic posts?',
      ...
      es: [
        ...
        { q: '¿Cómo afectan los saltos de línea a la visibilidad de mi leyenda de TikTok?', a: 'El formato juega un papel enorme en el truncamiento. Cada vez que pulsas "Enter" para crear un salto de línea, aceleras la aparición del botón "…más". Si escribes un gancho de 30 caracteres pero inmediatamente añades un salto de línea debajo, todo lo que quede por debajo se ocultará. Mantén tu gancho inicial en una sola línea continua para garantizar la máxima visibilidad.' },
      ...
      de: [
        ...
        { q: 'Wie wirken sich Zeilenumbrüche auf die Sichtbarkeit meiner TikTok-Untertitel aus?', a: 'Die Formatierung spielt eine riesige Rolle beim Abschneiden. Jedes Mal, wenn du „Enter“ drückst, um einen Zeilenumbruch zu machen, beschleunigt dies das Erscheinen des „…mehr“-Buttons. Wenn du einen Hook von 30 Zeichen schreibst, aber direkt darunter einen Zeilenumbruch einfügst, wird alles darunter verborgen. Halte deinen Eröffnungs-Hook in einer durchgehenden Zeile, um maximale Sichtbarkeit zu garantieren.' },
      ...
      fr: [
        ...
        { q: 'Comment les sauts de ligne affectent-ils la visibilité de ma légende TikTok ?', a: 'Le formatage joue un rôle énorme dans la troncature. Chaque fois que vous appuyez sur « Entrée » pour créer un saut de ligne, cela accélère la vitesse d\'apparition du bouton « …plus ». Si vous écrivez une accroche de 30 caractères mais ajoutez immédiatement un saut de ligne en dessous, tout ce qui se trouve en dessous sera masqué. Gardez votre accroche d\'ouverture sur une ligne continue pour garantir une visibilité maximale.' },
      ...
      pt: [
        ...
        { q: 'Como as quebras de linha afetam a visibilidade da minha legenda no TikTok?', a: 'A formatação tem um papel enorme no truncamento. Cada vez que você pressiona "Enter" para criar uma quebra de linha, acelera a rapidez com que o botão "…mais" aparece. Se você escrever um gancho de 30 caracteres, mas adicionar imediatamente uma quebra de linha abaixo dele, tudo o que estiver embaixo ficará oculto. Mantenha seu gancho inicial em uma única linha contínua para garantir visibilidade máxima.' },
      ...
      it: [
        ...
        { q: 'In che modo le interruzioni di riga influiscono sulla visibilità della mia didascalia di TikTok?', a: 'La formattazione gioca un ruolo enorme nel troncamento. Ogni volta che premi "Invio" per creare un\'interruzione di riga, acceleri la velocità con cui appare il pulsante "…altro". Se scrivi un gancio di 30 caratteri ma aggiungi subito un\'interruzione di riga sotto di esso, tutto ciò che si trova sotto verrà nascosto. Mantieni il tuo gancio di apertura su un\'unica riga continua per garantire la massima visibilità.' },
      ...
      nl: [
        ...
        { q: 'Hoe beïnvloeden regeleinden de zichtbaarheid van mijn TikTok-bijschrift?', a: 'Opmaak speelt een enorme rol bij het afkappen. Elke keer dat je op "Enter" drukt om een regeleinde te maken, versnelt dit hoe snel de "…meer"-knop verschijnt. Als je een hook van 30 tekens schrijft, maar er direct een regeleinde onder toevoegt, wordt alles daaronder verborgen. Houd je openingshook op één doorlopende regel om maximale zichtbaarheid te garanderen.' },
      ...
      ja: [
        ...
        { q: '改行はTikTokのキャプションの可視性にどのように影響しますか？', a: 'フォーマットは切り捨てに大きな役割を果たします。「Enter」を押して改行を作成するたびに、「…続きを見る」ボタンが表示されるのが早まります。30文字のフックを書いても、そのすぐ下に改行を追加すると、それ以下のすべてが隠れてしまいます。最大限の可視性を保証するために、冒頭のフックは改行なしの1行に収めてください。' },
      ...
      zh: [
        ...
        { q: '换行符如何影响我的 TikTok 文案可见性？', a: '格式在截断中扮演着重要角色。每次按"回车键"创建换行符，都会加快「…更多」按钮出现的速度。如果你写了一个 30 字符的钩子，但立即在其下方添加换行符，换行符之后的所有内容都会被隐藏。将你的开场钩子保持在一行连续文字中，以保证最大可见度。' },
      ...
      da: [
        ...
        { q: 'Hvordan påvirker linjeskift synligheden af min TikTok-billedtekst?', a: 'Formatering spiller en kæmpe rolle i afkortningen. Hver gang du trykker "Enter" for at lave et linjeskift, fremskynder det, hvor hurtigt "…mere"-knappen vises. Hvis du skriver en krog på 30 tegn, men straks laver et linjeskift under den, vil alt nedenunder blive skjult. Hold din indledende krog på én sammenhængende linje for at garantere maksimal synlighed.' },
        { q: 'Hvordan kan jeg forhåndsvise min TikTok-video for at tjekke for tekstoverlap?', a: 'Den mest pålidelige måde at undgå blokeret tekst er at teste dit layout, før du publicerer. Ved hjælp af PostTruncates live-simulator kan du indsætte dit udkast og øjeblikkeligt se, hvor teksten naturligt foldes. Du kan også uploade et videominaturebillede og slå det gennemsigtige sikkerhedszone-overlay til, så du sikrer, at din grafik på skærmen går helt fri af TikToks indbyggede knapper.' },
      ],
    },
...
<p>Esta es la regla que pilla por sorpresa. En el feed, TikTok solo muestra el inicio de tu leyenda y pliega el resto tras un toque de <strong>«…más»</strong>. El corte ocurre en el <strong>primer salto de línea O en torno a los primeros 100 caracteres, lo que ocurra primero</strong>. Si pones un salto de línea tras tu primera frase, todo lo de debajo desaparece tras el pliegue, aunque no estés cerca de los 100 caracteres.</p>
...
<p>Das ist die Regel, die Creator überrascht. Im Feed zeigt TikTok nur den Anfang deines Untertitels und klappt den Rest hinter einem <strong>„…mehr“</strong>-Tippen ein. Der Schnitt erfolgt am <strong>ersten Zeilenumbruch ODER bei etwa den ersten 100 Zeichen — je nachdem was zuerst kommt</strong>. Setz einen Zeilenumbruch nach deinem ersten Satz, und alles darunter verschwindet hinter dem Falz, selbst wenn du weit unter 100 Zeichen bist.</p>
...
<p>C’est la règle qui surprend les créateurs. Dans le fil, TikTok n’affiche que le début de votre légende et replie le reste derrière un appui sur <strong>« …plus »</strong>. La coupe se fait au <strong>premier saut de ligne OU vers les 100 premiers caractères — selon ce qui vient en premier</strong>. Mettez un saut de ligne après votre première phrase et tout ce qui suit disparaît derrière le pli, même loin des 100 caractères.</p>
...
<p>Esta é a regra que pega os criadores de surpresa. No feed, o TikTok mostra apenas o início da sua legenda e dobra o resto atrás de um toque em <strong>"…mais"</strong>. O corte acontece na <strong>primeira quebra de linha OU por volta dos primeiros 100 caracteres — o que vier primeiro</strong>. Coloque uma quebra de linha após a primeira frase e tudo abaixo dela desaparece atrás da dobra, mesmo longe dos 100 caracteres.</p>
...
<p>È la regola che coglie impreparati i creator. Nel feed, TikTok mostra solo l’inizio della didascalia e piega il resto dietro un tocco su <strong>"…altro"</strong>. Il taglio avviene al <strong>primo a capo OPPURE intorno ai primi 100 caratteri — a seconda di cosa viene prima</strong>. Metti un a capo dopo la prima frase e tutto ciò che sta sotto sparisce dietro la piega, anche se sei lontano dai 100 caratteri.</p>
...
<p>Dit is de regel die makers verrast. In de feed toont TikTok alleen het begin van je bijschrift en vouwt de rest achter een <strong>"…meer"</strong>-tik. De knip valt bij het <strong>eerste regeleinde OF rond de eerste 100 tekens — wat het eerst komt</strong>. Zet een regeleinde na je eerste zin en alles eronder verdwijnt achter de vouw, ook al zit je lang niet aan 100 tekens.</p>
...
<p>これがクリエイターの不意を突くルールです。フィードでTikTokはキャプションの冒頭だけを表示し、残りを<strong>「…続きを見る」</strong>のタップの後ろに折りたたみます。カットは<strong>最初の改行、または約100文字のうち早いほう</strong>で起こります。最初の一文の後に改行を入れると、100文字に遠く届かなくても、その下はすべて折り返しの後ろに消えます。</p>
...
<p>这是让创作者措手不及的规则。在信息流中，TikTok 只显示文案开头，把其余内容折叠在 <strong>「…更多」</strong> 点按之后。截断发生在 <strong>首个换行，或大约前 100 个字符——以先到者为准</strong>。在第一句后加一个换行，下面的一切就会消失在折叠之后，即使你离 100 字符还很远。</p>
...
<p>Det er reglen, der overrumpler kreatører. I feedet viser TikTok kun begyndelsen af din billedtekst og folder resten bag et <strong>"…mere"</strong>-tryk. Snittet sker ved det <strong>første linjeskift ELLER omkring de første 100 tegn — alt efter hvad der kommer først</strong>. Sæt et linjeskift efter din første sætning, og alt nedenunder forsvinder bag folden, selv hvis du er langt fra 100 tegn.</p>
...
<p>Til reference når du sætter op eller rydder op i en profil: en TikTok-<strong>bio rummer 80 tegn</strong>, <strong>@navnet (brugernavnet) rummer 24</strong>, og <strong>visningsnavnet rummer 30</strong>. De er korte med vilje — behandl bioen som én skarp linje, ikke et afsnit.</p>
<p>TikToks For dig-feed belønner visningstid og svar over finish. En billedtekst, der stiller et spørgsmål, lægger op til en pointe eller inviterer folk til at gøre tanken færdig i kommentarerne, slår konsekvent et pænt resumé. Brug PostTruncate til at skrive din billedtekst, tjekke tællingen, bekræfte at din krog klarer "…mere"-folden og forhåndsvise den over en 9:16-reel — alt sammen før du åbner appen.</p>`,
    },
  },
];
