...
The fix was simple: swap the 7-character skin-tone emoji for the base version (2 characters). Five characters back. Hook restored. The version with the base emoji outperformed the original by a significant margin.
...
The problem is that the LinkedIn "See more" cutoff isn't triggered purely by character count. It's also triggered by **physical vertical height** - specifically, the number of rendered lines a post occupies before the fold. LinkedIn typically collapses posts after **3 to 5 visible lines** on mobile, depending on the device resolution and font rendering.

A double line break in broetry takes up two lines of height with essentially zero characters. Do that between every sentence and you've consumed your entire vertical budget before you've said anything interesting.

Here's what this looks like in practice. A three-sentence intro in flowing prose might occupy 3-4 lines and sit entirely above the mobile fold. The exact same three sentences formatted as broetry - with double line breaks between each - could occupy 7-9 lines, triggering "See more" after just the first sentence.
...
Here's where the copywriting psychology matters. LinkedIn's fold is a conversion event. The reader either clicks through or scrolls on, and their decision takes less than a second. Understanding what drives that click is the whole game.

### Short bold statements, not questions

Questions were everywhere on LinkedIn three or four years ago. "Have you ever felt like your team just wasn't aligned?" "What's the biggest mistake you made in your first year of business?" They felt conversational, and for a while they worked.

They don't anymore - at least not as a lead. [Research on social media hooks](/en/blog/high-impact-social-media-hooks) consistently shows that **short, declarative statements of 5-10 words outperform questions as opening lines**. The reason is cognitive: a question puts the mental load on the reader to answer it, and a distracted scroller doesn't have that bandwidth. A bold statement, by contrast, does the work for them - it presents a specific reality that's either true or surprising enough to demand explanation.

"I fired my best client last year." That's a 5-word statement with a ready-made tension. It raises a question without asking one.

"We cut our onboarding drop-off by 40% by removing one form field." That's a number with a claim. The reader either believes it (and wants to know which field) or doesn't (and wants to know how you're measuring it). Either way, they click.

Questions work as a follow-up - after the statement has earned attention, posing a question in sentence two invites the reader into a dialogue they're already engaged in. Lead with a statement, follow with a question. Not the other way around.

### The open loop

The most reliable hook technique in 2026 is the open loop: starting a story or insight mid-scene, creating an information gap that can only be closed by reading past the fold.

The key is specificity. Generic open loops ("Something happened that changed how I think about sales forever") create no actual tension. Specific ones do.
...
The failure mode is telegraphing the resolution before the click. "I said no to a $20,000 project and here's why it was actually smart" closes the loop in the hook itself. The reader already has the answer. No click needed.

### The credibility spike

A third option that works especially well for founders and operators: lead with a number that establishes instant credibility.

"After 50 LinkedIn posts and $0 on ads, here's what we know about reach."

"We ran 200 A/B tests on LinkedIn hooks this year. One pattern won every time."
...
I've been writing LinkedIn posts for years and coaching other creators on their copy, and I've developed a personal heuristic that's held up: **the first five words of your post have to carry the entire post.**
...
The emotional triggers that reliably stop a scroll are:

**Surprise** - information that contradicts what the reader assumed. "LinkedIn posts with no images consistently outperform image posts in B2B reach." The reader expected the opposite. They need to know why.

**Recognition** - something that mirrors a specific pain the reader has felt. "I spent 45 minutes writing a LinkedIn post and got 11 impressions." Every creator who has been there nods. They click.

**High stakes** - a decision with real consequences. "$20,000 project." "Series A funding." "Lost the client." The number or the outcome signals that this is not a theoretical post. Real things happened. The reader wants to know what they were.

**Specific social proof** - not "many companies" but "73 companies" or "after my 12th post." Specificity is the signal that you actually did the thing.
...
-   **Write your hook** - strong, specific, declarative or open-loop
-   **Check emoji weight** - if you're near 140 characters, audit every emoji for character count
-   **Cut double line breaks from the first 3 sentences** - single breaks only until you're past the fold
-   **Preview in mobile view** - is the full hook above the fold line?
-   **Preview in desktop view** - does the next sentence reinforce or reward the click?
-   **Publish**
