  ...
  seoCopy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Le <strong>compteur de caractères SMS</strong> professionnel va bien au-delà des simples vérifications de longueur de texte en analysant en temps réel les structures de données de télécommunication sous-jacentes de votre message. Conçu spécifiquement pour les flux de messagerie complexes, l’outil distingue avec précision le <strong>codage GSM 7 bits</strong> standard (qui autorise jusqu’à 160 caractères par message unique) et le <strong>codage Unicode</strong> (qui réduit votre limite à 70 caractères).',
          'De plus, il prend en compte les subtilités techniques cachées qui entraînent des facturations inattendues de l’opérateur. Par exemple, il détecte les <strong>caractères de la table étendue GSM</strong>—tels que le symbole de l’euro (€), les crochets [ ], les accolades { } et la barre verticale (|)—, qui restent en toute sécurité en mode GSM-7 mais consomment instantanément 2 emplacements de caractère chacun.',
          'Si votre texte marketing dépasse un seul seuil, notre <strong>calculateur de segments SMS</strong> intégré estime les découpages exacts en messages multipartites, en tenant compte des en-têtes de données utilisateur (UDH) invisibles qui réduisent les limites des messages multipartites à 153 caractères pour GSM ou 67 caractères pour Unicode.',
        ],
      },
      {
