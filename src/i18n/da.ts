...
export const da: Translations = {
  ...
  pages: {
    ...
    contact: {
      eyebrow: 'Vi er her for at hjælpe',
      title: 'Kontakt os',
      description:
  ...
  island: {
    adPreviews: {
      ...
      placeholders: {
        ...
        cardHeadline: 'Din kortoverskrift',
        cardDescription: 'Tilføj en kort beskrivelse',
      },
      counter: '{n} / {limit}',
      over: '{n} for meget',
      previewLabel: 'Live forhåndsvisning',
      ...
      feed: 'Feed',
      reels: 'Reels',
      formatAria: 'Vælg annonceformat',
      formatFeed: 'Feed',
      formatReels: 'Reels',
      formatCarousel: 'Karrusel',
      carouselAddCard: 'Tilføj kort',
      carouselRemoveCard: 'Fjern kort',
      carouselMaxReached: 'Maksimum på {max} kort nået',
      carouselMinReached: 'Mindst {min} kort kræves',
      carouselPrev: 'Forrige kort',
      carouselNext: 'Næste kort',
      carouselPosition: '{current} / {total}',
      cardN: 'Kort {n}',
      cardHeadline: 'Kortoverskrift',
      cardDescription: 'Kortbeskrivelse',
