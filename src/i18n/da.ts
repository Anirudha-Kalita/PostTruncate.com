...
export const da: Translations = {
  ...
  nav: {
    ...
    links: { editor: 'Editor', guides: 'Platformsguides', faq: 'FAQ' },
    cta: 'Åbn editoren',
  ...
  island: {
    ...
    workspace: {
      ...
      placeholder:
        'Begynd at skrive dit opslag. Indsæt et udkast, smid et par links og hashtags ind, og se hver platforms preview opdatere til højre…',
      counters: {
        characters: 'Tegn',
        words: 'Ord',
        lines: 'Linjer',
