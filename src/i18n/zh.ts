      ...
      sections: [
        {
          heading: '它能做什么',
          paragraphs: [
            '只需撰写或粘贴一次草稿，PostTruncate 就会按照 <strong>LinkedIn、X、Threads、Instagram 和 Facebook</strong> 实际呈现的方式渲染它——“…查看更多”折叠、280 个字符的串文拆分、23 个字符的链接计重、30 个话题标签的上限。在你决定发布之前，你就能精准看到折叠线以上有哪些内容能够留存。',
