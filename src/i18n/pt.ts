...
export const pt: Translations = {
  ...
  nav: {
    ...
    links: {
      ...
      adPreviews: 'Pré-visualizações de anúncios',
      faq: 'FAQ',
      about: 'Sobre',
      contact: 'Contacto',
    },
    ...
    bookmarkToast: {
      heading: 'Achou útil?',
      desktopBody: 'Pressione {shortcut} para guardar esta página e encontrá-la num instante.',
      mobileBody: 'Guarde esta ferramenta para tê-la a um toque na próxima vez.',
      mobileButton: 'Guardar ou partilhar esta página',
      copied: 'Link copiado!',
      close: 'Fechar',
    },
  },
  ...
  howItWorks: {
    heading: 'Veja como funciona em 3 passos simples',
    steps: [
      {
        name: 'Cole o seu texto',
        text: 'Cole ou escreva o seu conteúdo no editor.',
      },
      {
        name: 'Analisamos instantaneamente',
        text: 'Verificamos a contagem de caracteres, os pontos de truncagem e os limites de cada plataforma em tempo real.',
      },
      {
        name: 'Publique com confiança',
        text: 'Veja exatamente como vai aparecer e publique sem se preocupar com texto cortado.',
      },
    ],
  },
  ...
  footer: {
    ...
    features: {
      realtime: 'Pré-visualizações em tempo real',
      privacy: 'Privacidade em primeiro lugar',
      noData: 'Sem dados armazenados',
      everywhere: 'Funciona em todo o lado',
    },
    followUs: 'Siga-nos',
    newsletter: {
      heading: 'Fique a par',
      sub: 'Dicas, novidades e novas ferramentas — direto no seu e-mail.',
      placeholder: 'Introduza o seu e-mail',
      button: 'Subscrever',
      success: 'Subscrição efetuada, obrigado!',
    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'A única funcionalidade que envia dados para fora do seu dispositivo é o <a href="../contact/"><strong>formulário de contacto</strong></a>. Quando opta por enviar-nos uma mensagem, o nome, o e-mail e a mensagem que introduz são-nos entregues através de um serviço terceiro de processamento de formulários, para que os possamos ler e responder. Usamos essa informação exclusivamente para lhe responder e não a utilizamos para marketing. Se preferir não recorrer a terceiros, pode enviar-nos um e-mail diretamente.',
            'Além disso, se subscrever as novidades através da caixa de e-mail no rodapé do nosso site, o endereço de e-mail que introduz é enviado para o nosso fornecedor de envio de e-mails e aí armazenado para que possamos enviar-lhe essas novidades. Usamo-lo apenas para essas novidades e nunca para mais nada, e pode cancelar a subscrição a qualquer momento.',
          ],
        },
        {
          heading: 'Alterações e contacto',
          paragraphs: [
            'Podemos atualizar esta política à medida que o produto evolui; a data de «última atualização» acima reflete sempre a versão atual. Se tiver alguma questão sobre privacidade, envie-nos um e-mail para <a href="mailto:contact@posttruncate.com"><strong>contact@posttruncate.com</strong></a>.',
          ],
        },
      ],
    },
    ...
    terms: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Podemos rever estes termos de tempos a tempos; a data de «última atualização» acima reflete a versão atual, e a utilização continuada da ferramenta significa que aceita os termos mais recentes. Dúvidas? Envie um e-mail para <a href="mailto:contact@posttruncate.com"><strong>contact@posttruncate.com</strong></a>.',
          ],
        },
      ],
    },
  ...
  whyPostTruncate: {
    ...
    title: 'Escreva com <span class="why-title__accent">confiança.</span><br/>Publique sem preocupações.',
  ...
  howTruncationWorks: {
    ...
    title: 'Veja <span class="truncation-title__accent">exatamente</span> como a sua publicação vai aparecer',
    ...
    verified: 'Limites verificados pela última vez: {date}',
    platforms: {
  ...
  island: {
    adPreviews: {
      ...
      placeholders: {
        headline: 'O seu título',
        primary: 'Escreva o seu texto principal…',
        description: 'Adicione uma descrição curta',
        cardHeadline: 'O título do seu cartão',
        cardDescription: 'Adicione uma descrição curta',
      },
      counter: '{n} / {limit}',
      over: '{n} a mais',
      previewLabel: 'Pré-visualização ao vivo',
      deviceAria: 'Escolher dispositivo de pré-visualização',
      mobile: 'Telemóvel',
      desktop: 'Computador',
      modeAria: 'Escolher posicionamento',
      feed: 'Feed',
      reels: 'Reels',
      formatAria: 'Escolher formato do anúncio',
      formatFeed: 'Feed',
      formatReels: 'Reels',
      formatCarousel: 'Carrossel',
      carouselAddCard: 'Adicionar cartão',
      carouselRemoveCard: 'Remover cartão',
      carouselMaxReached: 'Máximo de {max} cartões atingido',
      carouselMinReached: 'É necessário um mínimo de {min} cartões',
      carouselPrev: 'Cartão anterior',
      carouselNext: 'Cartão seguinte',
      carouselPosition: '{current} / {total}',
      cardN: 'Cartão {n}',
      cardHeadline: 'Título do cartão',
      cardDescription: 'Descrição do cartão',
      safeZoneLabel: 'Zonas seguras',
      safeZoneHint: 'As faixas sombreadas mostram onde a interface cobre o seu criativo. Mantenha o texto importante fora delas.',
      safeZoneTag: 'Zona segura',
      reelsTooShort: 'Aponte para {min}–{max} caracteres para que a legenda se leia bem sobre o vídeo.',
      media: {
        add: 'Adicionar conteúdo',
        replace: 'Substituir conteúdo',
        remove: 'Remover conteúdo',
        hint: 'Pré-visualizado apenas no seu navegador — nunca carregado nem armazenado.',
      },
      badgeFits: 'Cabe',
      ...
      googleHeadlinesDropped: {
        ...
        other: '{n} títulos removidos — a largura combinada excede o espaço de anúncio de {px} px no computador.',
      },
      cta: {
        'Shop Now': 'Comprar',
        ...
        'Order Now': 'Encomendar',
        'Watch Now': 'Assistir',
        'Apply': 'Candidatar-se',
        'Register': 'Registar-se',
        'Join': 'Participar',
        'Attend': 'Comparecer',
        'Request Demo': 'Solicitar demonstração',
        'View Quote': 'Ver orçamento',
      },
    },
    dashboard: {
    ...
    meta: {
      ...
      likedBy: 'Curtido por {handle} e outras pessoas',
      viewAllComments: 'Ver todos os {n} comentários',
      commentsCount: '{n} comentários',
      sharesCount: '{n} compartilhamentos',
