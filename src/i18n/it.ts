...
export const it: Translations = {
  ...
  nav: {
    ...
    backToTop: 'Torna su',
    bookmarkToast: {
      heading: 'Ti è stato utile?',
      desktopBody: 'Premi {shortcut} per salvare questa pagina e ritrovarla in un attimo.',
      mobileBody: 'Salva questo strumento per averlo a portata di tocco la prossima volta.',
      mobileButton: 'Salva o condividi questa pagina',
      copied: 'Link copiato!',
      close: 'Chiudi',
    },
  },
  ...
  hero: {
    ...
    lede: 'Scrivi una sola volta e guarda il tuo post nelle anteprime native di LinkedIn, X, TikTok, Threads, Instagram e Facebook: con righe della soglia, suddivisioni dei thread, limiti degli hashtag e avvisi di accessibilità in tempo reale mentre scrivi, più IA in un tocco per migliorare il tuo post sul momento.',
  ...
  howItWorks: {
    heading: 'Scopri come funziona in 3 semplici passaggi',
    steps: [
      {
        name: 'Incolla il tuo testo',
        text: 'Incolla o scrivi il tuo contenuto nell\'editor.',
      },
      {
        name: 'Analizziamo all\'istante',
        text: 'Controlliamo il conteggio dei caratteri, i punti di troncamento e i limiti delle piattaforme in tempo reale.',
      },
      {
        name: 'Pubblica con sicurezza',
        text: 'Guarda esattamente come apparirà e pubblica senza preoccuparti del testo tagliato.',
      },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'PostTruncate offre anteprime per LinkedIn, X (Twitter), TikTok, Threads, Instagram, Facebook e SMS — con conteggio caratteri in tempo reale, indicatori di piega, divisione in thread e calcolo dei segmenti SMS per ciascuna. Include anche un’anteprima della SERP di Google per titoli e meta description, e un widget contatore gratuito da incorporare nel tuo sito.',
      },
      {
  ...
  limitsPage: {
    ...
    description:
      'La tabella completa dei limiti di caratteri per LinkedIn, X (Twitter), TikTok, Threads, Instagram, Facebook e SMS — tetti rigidi, pieghe di troncamento e le regole che li governano.',
    eyebrow: 'Riferimento',
  ...
  footer: {
    ...
    features: {
      realtime: 'Anteprime in tempo reale',
      privacy: 'Privacy prima di tutto',
      noData: 'Nessun dato memorizzato',
      everywhere: 'Funziona ovunque',
    },
    followUs: 'Seguici',
    newsletter: {
      heading: 'Resta aggiornato',
      sub: 'Consigli, novità e nuovi strumenti — direttamente nella tua casella.',
      placeholder: 'Inserisci la tua email',
      button: 'Iscriviti',
      success: 'Iscrizione riuscita, grazie!',
    ...
    disclaimer:
      'Non affiliato a LinkedIn, X, TikTok, Meta o Instagram. I limiti sono stime e possono cambiare.',
  },
    ...
    terms: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            'PostTruncate è uno strumento indipendente e <strong>non è affiliato, approvato o sponsorizzato da</strong> LinkedIn, X (Twitter), TikTok, Meta, Instagram, Facebook o Threads. Tutti i nomi di prodotti, i loghi e i marchi sono di proprietà dei rispettivi titolari e sono usati qui solo per descrivere il comportamento di ciascuna piattaforma.',
          ],
        },
        {
  ...
  whyPostTruncate: {
    ...
    title: 'Scrivi con <span class="why-title__accent">sicurezza.</span><br/>Pubblica senza preoccupazioni.',
  ...
  howTruncationWorks: {
    ...
    verified: 'Limiti verificati l\'ultima volta: {date}',
    platforms: {
  ...
  island: {
    adPreviews: {
      editorLabel: 'Crea il tuo annuncio',
      fields: {
        headline: 'Titolo',
      ...
      placeholders: {
        ...
        cardHeadline: 'Il titolo della tua scheda',
        cardDescription: 'Aggiungi una breve descrizione',
      },
      counter: '{n} / {limit}',
      over: '{n} in più',
      ...
      feed: 'Feed',
      reels: 'Reels',
      formatAria: 'Scegli il formato dell’annuncio',
      formatFeed: 'Feed',
      formatReels: 'Reels',
      formatCarousel: 'Carosello',
      carouselAddCard: 'Aggiungi scheda',
      carouselRemoveCard: 'Rimuovi scheda',
      carouselMaxReached: 'Raggiunto il massimo di {max} schede',
      carouselMinReached: 'Sono richieste almeno {min} schede',
      carouselPrev: 'Scheda precedente',
      carouselNext: 'Scheda successiva',
      carouselPosition: '{current} / {total}',
      cardN: 'Scheda {n}',
      cardHeadline: 'Titolo della scheda',
      cardDescription: 'Descrizione della scheda',
      ...
      promoted: 'Post sponsorizzato',
      googleAdLabel: 'Sponsorizzato',
      finalUrl: 'URL finale',
      pathN: 'Percorso {n}',
      displayLink: 'Link visualizzato / URL di destinazione',
      callToAction: 'Invito all’azione',
      adLabel: 'Sponsorizzato',
      fbHeadlineSqueezed: 'Titolo oltre {limit} caratteri su mobile: la descrizione del link viene nascosta.',
      googleHeadlinesDropped: {
        one: '{n} titolo rimosso: la larghezza combinata supera lo spazio annuncio da {px} px su desktop.',
        other: '{n} titoli rimossi: la larghezza combinata supera lo spazio annuncio da {px} px su desktop.',
      },
      cta: {
    ...
    share: {
      ...
      mediaNote: 'Viene condiviso solo il testo: i media non sono inclusi.',
    },
    aiImprove: {
      button: 'Migliora con IA',
      pickTone: 'Migliora con IA',
      pickToneSub: 'Scegli un tono — l’IA riscrive il tuo post.',
      hint: 'Novità: riscrivi il tuo post con un tocco — scegli un tono.',
      hintDismiss: 'Chiudi',
      tones: {
    ...
    meta: {
      ...
      likedBy: 'Piace a {handle} e altri',
      viewAllComments: 'Visualizza tutti i {n} commenti',
      commentsCount: '{n} commenti',
      sharesCount: '{n} condivisioni',
      repostsCount: '{n} diffusioni',
      repliesCount: '{n} risposte',
      likesCount: '{n} mi piace',
      reelAudio: 'Audio originale',
      follow: 'Segui',
      reelAudioUses: '{n} utenti',
      subscribe: 'Iscriviti',
