  ...
  seoCopy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Il <strong>contatore di caratteri SMS</strong> professionale va ben oltre i semplici controlli sulla lunghezza del testo, analizzando in tempo reale le strutture di dati delle telecomunicazioni alla base del tuo messaggio. Progettato specificamente per flussi di messaggistica complessi, lo strumento distingue con precisione tra la <strong>codifica GSM a 7 bit</strong> standard (che consente fino a 160 caratteri per singolo messaggio) e la <strong>codifica Unicode</strong> (che riduce il tuo limite a 70 caratteri).',
          'Inoltre, tiene conto delle sfumature tecniche nascoste che causano addebiti imprevisti da parte dell’operatore. Ad esempio, rileva i <strong>caratteri della tabella estesa GSM</strong>—come il simbolo dell’euro (€), le parentesi quadre [ ], le parentesi graffe { } e il simbolo pipe (|)—che rimangono in sicurezza in modalità GSM-7 ma consumano istantaneamente 2 spazi di carattere ciascuno.',
          'Se il tuo testo di marketing supera una singola soglia, il nostro <strong>calcolatore di segmenti SMS</strong> integrato stima le suddivisioni esatte in messaggi multiparte, tenendo conto degli invisibili User Data Header (UDH) che riducono i limiti dei messaggi multiparte a 153 caratteri per GSM o 67 caratteri per Unicode.',
        ],
      },
      {
