  ...
  seoCopy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Der professionelle <strong>SMS-Zeichenzähler</strong> geht weit über einfache Textlängenprüfungen hinaus und analysiert die zugrunde liegenden Telekommunikations-Datenstrukturen deiner Nachricht in Echtzeit. Speziell für komplexe Messaging-Workflows entwickelt, unterscheidet das Tool präzise zwischen der standardmäßigen <strong>GSM 7-bit-Kodierung</strong> (die bis zu 160 Zeichen pro einzelner Nachricht erlaubt) und der <strong>Unicode-Kodierung</strong> (die dein Limit auf 70 Zeichen reduziert).',
          'Darüber hinaus berücksichtigt es die verborgenen technischen Feinheiten, die zu unerwarteten Gebühren des Mobilfunkanbieters führen. So erfasst es beispielsweise <strong>Zeichen der erweiterten GSM-Tabelle</strong>—wie das Euro-Symbol (€), eckige Klammern [ ], geschweifte Klammern { } und das Pipe-Symbol (|)—, die zwar sicher im GSM-7-Modus bleiben, aber sofort jeweils 2 Zeichenplätze verbrauchen.',
          'Wenn dein Marketingtext eine einzelne Schwelle überschreitet, schätzt unser integrierter <strong>SMS-Segment-Rechner</strong> die genaue Aufteilung in mehrteilige Nachrichten und berücksichtigt dabei die unsichtbaren User Data Headers (UDH), die die Grenzen mehrteiliger Nachrichten auf 153 Zeichen bei GSM oder 67 Zeichen bei Unicode reduzieren.',
        ],
      },
      {
