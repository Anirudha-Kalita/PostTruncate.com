...
export const de: Translations = {
  ...
  toolPage: {
    ...
    crossPromo: {
      ...
      text: 'PostTruncate ist nicht nur für {platform}. Der vollständige Editor auf der Startseite zeigt deinen Beitrag gleichzeitig für LinkedIn, X, Instagram, Facebook, Threads und TikTok in der Vorschau — so erkennst du Fold, Limit und Codierungsfallen jeder Plattform in einem Durchgang. Einmal schreiben, überall prüfen.',
      cta: 'Vollständigen Editor öffnen',
    },
    cta: {
      heading: 'Bereit zu sehen, wie dein Beitrag wirklich aussieht?',
      blurb: 'Füge deinen Entwurf in den PostTruncate-Editor ein und sieh sofort Live-Vorschauen für LinkedIn, X, Instagram, Facebook, Threads und TikTok — mit Fold-Markierungen, Thread-Aufteilungen und Zeichenlimit-Warnungen, die sich beim Tippen aktualisieren. Kostenlos, sofort und nichts verlässt deinen Browser.',
  ...
  island: {
    adPreviews: {
      ...
      placeholders: {
        ...
        cardHeadline: 'Dein Karten-Titel',
        cardDescription: 'Füge eine kurze Beschreibung hinzu',
      },
      counter: '{n} / {limit}',
      over: '{n} darüber',
      previewLabel: 'Live-Vorschau',
      ...
      feed: 'Feed',
      reels: 'Reels',
      formatAria: 'Anzeigenformat wählen',
      formatFeed: 'Feed',
      formatReels: 'Reels',
      formatCarousel: 'Karussell',
      carouselAddCard: 'Karte hinzufügen',
      carouselRemoveCard: 'Karte entfernen',
      carouselMaxReached: 'Maximum von {max} Karten erreicht',
      carouselMinReached: 'Mindestens {min} Karten erforderlich',
      carouselPrev: 'Vorherige Karte',
      carouselNext: 'Nächste Karte',
      carouselPosition: '{current} / {total}',
      cardN: 'Karte {n}',
      cardHeadline: 'Karten-Titel',
      cardDescription: 'Karten-Beschreibung',
      ...
      googleHeadlinesDropped: {
        ...
        other: '{n} Titel entfernt – die kombinierte Breite überschreitet den {px} px breiten Desktop-Anzeigenplatz.',
      },
      cta: {
