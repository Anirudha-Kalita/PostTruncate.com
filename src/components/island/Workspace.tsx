  ...
  return (
    <Card class="flex flex-col">
      ...
      <div class="flex flex-col p-4 sm:p-5">
        ...
        {hidden.count > 0 && (
          <p class="mt-3 flex items-start gap-1.5 text-[12px] leading-4 font-medium text-warning-deep">
        ...
        <p class="mt-3 flex items-center gap-2 text-[12px] leading-4 font-medium text-mute">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="shrink-0 text-cyan-deep" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>
          {w.statusLine}
        </p>
